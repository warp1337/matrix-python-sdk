...
class MatrixClient(object):
    ...
    def __init__(self, base_url, token=None, user_id=None,
        ...
        self.encryption_conf = encryption_conf
    ...
    def login(self, username, password, limit=10, sync=True, device_id=None):
        ...
        if self.encryption:
            if ENCRYPTION_SUPPORT:
                ...
                logger.error("Failed to enable encryption. Please make sure the olm "
    ...
    def _sync(self, timeout_ms=30000):
        ...
        if self.encryption and 'device_lists' in response:
        ...
        if self.encryption and self.first_sync:
