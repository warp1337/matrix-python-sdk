...
class Room(object):
    ...
    def send_text(self, text):
        ...
        if self.encrypted and self.client.encryption and self.client.encryption:
    ...
    def send_html(self, html, body=None, msgtype="m.text"):
        ...
        if self.encrypted and self.client.encryption:
    ...
    def _put_event(self, event):
        if self.encrypted and self.client.encryption:
            if event['type'] == 'm.room.encrypted' and self.client.encryption:
                try:
